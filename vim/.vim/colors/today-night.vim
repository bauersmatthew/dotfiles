...
call s:Hl('Function'  , 'yellow'    , 'background', 'bold')
call s:Hl('Statement' , 'blue'      , 'background', 'bold')
call s:Hl('Operator'  , 'aqua'      , 'background', 'none')
call s:Hl('PreProc'   , 'red'       , 'background', 'bold')
call s:Hl('Type'      , 'orange'    , 'background', 'bold')
call s:Hl('Structure' , 'aqua'      , 'background', 'bold')
call s:Hl('Special'   , 'green'     , 'background', 'bold')
call s:Hl('Underlined', 'blue'      , 'background', 'none')
call s:Hl('Ignore'    , 'foreground', 'background', 'none')
call s:Hl('Error'     , 'red'       , 'background', 'bold')
call s:Hl('Todo'      , 'orange'    , 'background', 'bold')
